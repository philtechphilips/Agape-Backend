...
{
    use HasFactory;
    protected $fillable = ['stuId', 'examId', 'section', 'total', 'grade', 'remarks', 'termId', 'term', 'surname', 'firstname', 'subject', 'classId', 'firstTerm', 'ca', 'exam_mark', 'session', 'is_result_released'];
